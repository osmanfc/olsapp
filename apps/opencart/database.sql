...
--
-- Host: localhost:3306
-- Generation Time: Jun 28, 2025 at 06:15 PM
...
--
-- Table structure for table `myopencart_address`
--

CREATE TABLE `myopencart_address` (
...
--
-- Table structure for table `myopencart_address_format`
--

CREATE TABLE `myopencart_address_format` (
...
--
-- Dumping data for table `myopencart_address_format`
--

INSERT INTO `myopencart_address_format` (`address_format_id`, `name`, `address_format`) VALUES
(1, 'Address Format', '{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}');

-- --------------------------------------------------------

--
-- Table structure for table `myopencart_antispam`
--

CREATE TABLE `myopencart_antispam` (
...
--
-- Table structure for table `myopencart_api`
--

CREATE TABLE `myopencart_api` (
...
--
-- Dumping data for table `myopencart_api`
--

INSERT INTO `myopencart_api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '[[time_now]]', '[[time_now]]');

-- --------------------------------------------------------

--
-- Table structure for table `myopencart_api_history`
--

CREATE TABLE `myopencart_api_history` (
...
--
-- Table structure for table `myopencart_api_ip`
--

CREATE TABLE `myopencart_api_ip` (
...
--
-- Table structure for table `myopencart_article`
--

CREATE TABLE `myopencart_article` (
...
--
-- Table structure for table `myopencart_article_comment`
--

CREATE TABLE `myopencart_article_comment` (
...
--
-- Table structure for table `myopencart_article_description`
--

CREATE TABLE `myopencart_article_description` (
  `article_id` int(11) NOT NULL,
...
--
-- Table structure for table `myopencart_article_rating`
--

CREATE TABLE `myopencart_article_rating` (
...
--
-- Table structure for table `myopencart_article_to_layout`
--

CREATE TABLE `myopencart_article_to_layout` (
  `article_id` int(11) NOT NULL,
...
--
-- Table structure for table `myopencart_article_to_store`
--

CREATE TABLE `myopencart_article_to_store` (
  `article_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_attribute`
--

CREATE TABLE `myopencart_attribute` (
...
--
-- Dumping data for table `myopencart_attribute`
--

INSERT INTO `myopencart_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Table structure for table `myopencart_attribute_description`
--

CREATE TABLE `myopencart_attribute_description` (
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `myopencart_attribute_description`
--

INSERT INTO `myopencart_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(3, 1, 'Clockspeed'),
(4, 1, 'test 1'),
...
--
-- Table structure for table `myopencart_attribute_group`
--

CREATE TABLE `myopencart_attribute_group` (
  `attribute_group_id` int(11) NOT NULL,
  `sort_order` int(3) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `myopencart_attribute_group`
--

INSERT INTO `myopencart_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Table structure for table `myopencart_attribute_group_description`
--

CREATE TABLE `myopencart_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `myopencart_attribute_group_description`
--

INSERT INTO `myopencart_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor');
...
--
-- Table structure for table `myopencart_banner`
--

CREATE TABLE `myopencart_banner` (
...
--
-- Dumping data for table `myopencart_banner`
--

INSERT INTO `myopencart_banner` (`banner_id`, `name`, `status`) VALUES
(6, 'HP Products', 1),
...
--
-- Table structure for table `myopencart_banner_image`
--

CREATE TABLE `myopencart_banner_image` (
...
--
-- Dumping data for table `myopencart_banner_image`
--

INSERT INTO `myopencart_banner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `myopencart_cart`
--

CREATE TABLE `myopencart_cart` (
...
--
-- Table structure for table `myopencart_category`
--

CREATE TABLE `myopencart_category` (
...
--
-- Dumping data for table `myopencart_category`
--

INSERT INTO `myopencart_category` (`category_id`, `image`, `parent_id`, `sort_order`, `status`) VALUES
(17, '', 0, 4, 1),
...
--
-- Table structure for table `myopencart_category_description`
--

CREATE TABLE `myopencart_category_description` (
  `category_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `description` text DEFAULT NULL,
...
--
-- Dumping data for table `myopencart_category_description`
--

INSERT INTO `myopencart_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Table structure for table `myopencart_category_filter`
--

CREATE TABLE `myopencart_category_filter` (
  `category_id` int(11) NOT NULL,
...
--
-- Table structure for table `myopencart_category_path`
--

CREATE TABLE `myopencart_category_path` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `myopencart_category_path`
--

INSERT INTO `myopencart_category_path` (`category_id`, `path_id`, `level`) VALUES
(17, 17, 0),
(18, 18, 0),
(20, 20, 0),
(24, 24, 0),
...
--
-- Table structure for table `myopencart_category_to_layout`
--

CREATE TABLE `myopencart_category_to_layout` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0,
  `layout_id` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_category_to_store`
--

CREATE TABLE `myopencart_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `myopencart_category_to_store`
--

INSERT INTO `myopencart_category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
--
-- Table structure for table `myopencart_country`
--

CREATE TABLE `myopencart_country` (
...
--
-- Dumping data for table `myopencart_country`
--

INSERT INTO `myopencart_country` (`country_id`, `iso_code_2`, `iso_code_3`, `address_format_id`, `postcode_required`, `status`) VALUES
(1, 'AF', 'AFG', 1, 0, 1),
(2, 'AL', 'ALB', 1, 0, 1),
(3, 'DZ', 'DZA', 1, 0, 1),
(4, 'AS', 'ASM', 1, 0, 1),
...
--
-- Table structure for table `myopencart_country_description`
--

CREATE TABLE `myopencart_country_description` (
  `country_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `myopencart_country_description`
--

INSERT INTO `myopencart_country_description` (`country_id`, `language_id`, `name`) VALUES
...
--
-- Table structure for table `myopencart_coupon`
--

CREATE TABLE `myopencart_coupon` (
...
--
-- Dumping data for table `myopencart_coupon`
--

INSERT INTO `myopencart_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `myopencart_coupon_category`
--

CREATE TABLE `myopencart_coupon_category` (
  `coupon_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_coupon_history`
--

CREATE TABLE `myopencart_coupon_history` (
...
--
-- Table structure for table `myopencart_coupon_product`
--

CREATE TABLE `myopencart_coupon_product` (
...
--
-- Table structure for table `myopencart_cron`
--

CREATE TABLE `myopencart_cron` (
...
--
-- Dumping data for table `myopencart_cron`
--

INSERT INTO `myopencart_cron` (`cron_id`, `code`, `description`, `cycle`, `action`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `myopencart_currency`
--

CREATE TABLE `myopencart_currency` (
...
--
-- Dumping data for table `myopencart_currency`
--

INSERT INTO `myopencart_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
...
--
-- Table structure for table `myopencart_customer`
--

CREATE TABLE `myopencart_customer` (
...
--
-- Table structure for table `myopencart_customer_activity`
--

CREATE TABLE `myopencart_customer_activity` (
...
--
-- Table structure for table `myopencart_customer_affiliate`
--

CREATE TABLE `myopencart_customer_affiliate` (
  `customer_id` int(11) NOT NULL,
  `company` varchar(60) DEFAULT NULL,
...
--
-- Table structure for table `myopencart_customer_affiliate_report`
--

CREATE TABLE `myopencart_customer_affiliate_report` (
...
--
-- Table structure for table `myopencart_customer_approval`
--

CREATE TABLE `myopencart_customer_approval` (
...
--
-- Table structure for table `myopencart_customer_authorize`
--

CREATE TABLE `myopencart_customer_authorize` (
...
--
-- Table structure for table `myopencart_customer_group`
--

CREATE TABLE `myopencart_customer_group` (
...
--
-- Dumping data for table `myopencart_customer_group`
--

INSERT INTO `myopencart_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1, 0, 1),
(2, 0, 2),
(3, 1, 3);
...
--
-- Table structure for table `myopencart_customer_group_description`
--

CREATE TABLE `myopencart_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `myopencart_customer_group_description`
--

INSERT INTO `myopencart_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
...
--
-- Table structure for table `myopencart_customer_history`
--

CREATE TABLE `myopencart_customer_history` (
...
--
-- Table structure for table `myopencart_customer_ip`
--

CREATE TABLE `myopencart_customer_ip` (
...
--
-- Table structure for table `myopencart_customer_login`
--

CREATE TABLE `myopencart_customer_login` (
...
--
-- Table structure for table `myopencart_customer_online`
--

CREATE TABLE `myopencart_customer_online` (
...
--
-- Table structure for table `myopencart_customer_reward`
--

CREATE TABLE `myopencart_customer_reward` (
...
--
-- Table structure for table `myopencart_customer_search`
--

CREATE TABLE `myopencart_customer_search` (
...
--
-- Table structure for table `myopencart_customer_token`
--

CREATE TABLE `myopencart_customer_token` (
...
--
-- Table structure for table `myopencart_customer_transaction`
--

CREATE TABLE `myopencart_customer_transaction` (
...
--
-- Table structure for table `myopencart_customer_wishlist`
--

CREATE TABLE `myopencart_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `myopencart_custom_field`
--

CREATE TABLE `myopencart_custom_field` (
...
--
-- Dumping data for table `myopencart_custom_field`
--

INSERT INTO `myopencart_custom_field` (`custom_field_id`, `type`, `value`, `validation`, `location`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `myopencart_custom_field_customer_group`
--

CREATE TABLE `myopencart_custom_field_customer_group` (
  `custom_field_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
--
-- Dumping data for table `myopencart_custom_field_customer_group`
--

INSERT INTO `myopencart_custom_field_customer_group` (`custom_field_id`, `customer_group_id`, `required`) VALUES
(1, 1, 1),
(2, 1, 1),
(3, 1, 1),
(4, 1, 1),
...
--
-- Table structure for table `myopencart_custom_field_description`
--

CREATE TABLE `myopencart_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `myopencart_custom_field_description`
--

INSERT INTO `myopencart_custom_field_description` (`custom_field_id`, `language_id`, `name`) VALUES
(1, 1, 'Select'),
(2, 1, 'Radio'),
(3, 1, 'Checkbox'),
(4, 1, 'Text'),
...
--
-- Table structure for table `myopencart_custom_field_value`
--

CREATE TABLE `myopencart_custom_field_value` (
...
--
-- Dumping data for table `myopencart_custom_field_value`
--

INSERT INTO `myopencart_custom_field_value` (`custom_field_value_id`, `custom_field_id`, `sort_order`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 1),
...
--
-- Table structure for table `myopencart_custom_field_value_description`
--

CREATE TABLE `myopencart_custom_field_value_description` (
  `custom_field_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `custom_field_id` int(11) DEFAULT NULL,
  `name` varchar(128) DEFAULT NULL
...
--
-- Dumping data for table `myopencart_custom_field_value_description`
--

INSERT INTO `myopencart_custom_field_value_description` (`custom_field_value_id`, `language_id`, `custom_field_id`, `name`) VALUES
(1, 1, 1, 'Test 1'),
(2, 1, 1, 'test 2'),
(3, 1, 1, 'Test 3'),
(4, 1, 2, 'Test 1'),
...
--
-- Table structure for table `myopencart_download`
--

CREATE TABLE `myopencart_download` (
...
--
-- Table structure for table `myopencart_download_description`
--

CREATE TABLE `myopencart_download_description` (
  `download_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_download_report`
--

CREATE TABLE `myopencart_download_report` (
...
--
-- Table structure for table `myopencart_event`
--

CREATE TABLE `myopencart_event` (
...
--
-- Dumping data for table `myopencart_event`
--

INSERT INTO `myopencart_event` (`event_id`, `code`, `description`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `myopencart_extension`
--

CREATE TABLE `myopencart_extension` (
...
--
-- Dumping data for table `myopencart_extension`
--

INSERT INTO `myopencart_extension` (`extension_id`, `extension`, `type`, `code`) VALUES
...
--
-- Table structure for table `myopencart_extension_install`
--

CREATE TABLE `myopencart_extension_install` (
...
--
-- Dumping data for table `myopencart_extension_install`
--

INSERT INTO `myopencart_extension_install` (`extension_install_id`, `extension_id`, `extension_download_id`, `name`, `description`, `code`, `version`, `author`, `link`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `myopencart_extension_path`
--

CREATE TABLE `myopencart_extension_path` (
...
--
-- Dumping data for table `myopencart_extension_path`
--

INSERT INTO `myopencart_extension_path` (`extension_path_id`, `extension_install_id`, `path`) VALUES
(1, 1, 'opencart'),
(2, 1, 'opencart/admin'),
...
--
-- Table structure for table `myopencart_filter`
--

CREATE TABLE `myopencart_filter` (
  `filter_id` int(11) NOT NULL,
...
--
-- Table structure for table `myopencart_filter_description`
--

CREATE TABLE `myopencart_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_filter_group`
--

CREATE TABLE `myopencart_filter_group` (
...
--
-- Table structure for table `myopencart_filter_group_description`
--

CREATE TABLE `myopencart_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_gdpr`
--

CREATE TABLE `myopencart_gdpr` (
...
--
-- Table structure for table `myopencart_geo_zone`
--

CREATE TABLE `myopencart_geo_zone` (
...
--
-- Dumping data for table `myopencart_geo_zone`
--

INSERT INTO `myopencart_geo_zone` (`geo_zone_id`, `name`, `description`) VALUES
...
--
-- Table structure for table `myopencart_identifier`
--

CREATE TABLE `myopencart_identifier` (
...
--
-- Dumping data for table `myopencart_identifier`
--

INSERT INTO `myopencart_identifier` (`identifier_id`, `name`, `code`, `validation`, `status`) VALUES
...
--
-- Table structure for table `myopencart_information`
--

CREATE TABLE `myopencart_information` (
...
--
-- Dumping data for table `myopencart_information`
--

INSERT INTO `myopencart_information` (`information_id`, `sort_order`, `status`) VALUES
(1, 3, 1),
(2, 1, 1),
(3, 4, 1),
(4, 2, 1);
...
--
-- Table structure for table `myopencart_information_description`
--

CREATE TABLE `myopencart_information_description` (
  `information_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(64) DEFAULT NULL,
...
--
-- Dumping data for table `myopencart_information_description`
--

INSERT INTO `myopencart_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(1, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n', 'About Us', '', ''),
...
--
-- Table structure for table `myopencart_information_to_layout`
--

CREATE TABLE `myopencart_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0,
  `layout_id` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_information_to_store`
--

CREATE TABLE `myopencart_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `myopencart_information_to_store`
--

INSERT INTO `myopencart_information_to_store` (`information_id`, `store_id`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0);
...
--
-- Table structure for table `myopencart_language`
--

CREATE TABLE `myopencart_language` (
  `language_id` int(11) NOT NULL,
  `name` varchar(32) DEFAULT NULL,
...
--
-- Dumping data for table `myopencart_language`
--

INSERT INTO `myopencart_language` (`language_id`, `name`, `code`, `locale`, `extension`, `sort_order`, `status`) VALUES
(1, 'English', 'en-gb', 'en-gb,en', NULL, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `myopencart_layout`
--

CREATE TABLE `myopencart_layout` (
  `layout_id` int(11) NOT NULL,
  `name` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `myopencart_layout`
--

INSERT INTO `myopencart_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
--
-- Table structure for table `myopencart_layout_module`
--

CREATE TABLE `myopencart_layout_module` (
...
--
-- Dumping data for table `myopencart_layout_module`
--

INSERT INTO `myopencart_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
...
--
-- Table structure for table `myopencart_layout_route`
--

CREATE TABLE `myopencart_layout_route` (
...
--
-- Dumping data for table `myopencart_layout_route`
--

INSERT INTO `myopencart_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(1, 6, 0, 'account/%'),
...
--
-- Table structure for table `myopencart_length_class`
--

CREATE TABLE `myopencart_length_class` (
  `length_class_id` int(11) NOT NULL,
  `value` decimal(15,8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `myopencart_length_class`
--

INSERT INTO `myopencart_length_class` (`length_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 10.00000000),
(3, 0.39370000);
...
--
-- Table structure for table `myopencart_length_class_description`
--

CREATE TABLE `myopencart_length_class_description` (
  `length_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) DEFAULT NULL,
...
--
-- Dumping data for table `myopencart_length_class_description`
--

INSERT INTO `myopencart_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
...
--
-- Table structure for table `myopencart_location`
--

CREATE TABLE `myopencart_location` (
...
--
-- Table structure for table `myopencart_manufacturer`
--

CREATE TABLE `myopencart_manufacturer` (
...
--
-- Dumping data for table `myopencart_manufacturer`
--

INSERT INTO `myopencart_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `myopencart_manufacturer_to_layout`
--

CREATE TABLE `myopencart_manufacturer_to_layout` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0,
  `layout_id` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_manufacturer_to_store`
--

CREATE TABLE `myopencart_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `myopencart_manufacturer_to_store`
--

INSERT INTO `myopencart_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Table structure for table `myopencart_marketing`
--

CREATE TABLE `myopencart_marketing` (
...
--
-- Table structure for table `myopencart_marketing_report`
--

CREATE TABLE `myopencart_marketing_report` (
...
--
-- Table structure for table `myopencart_modification`
--

CREATE TABLE `myopencart_modification` (
...
--
-- Table structure for table `myopencart_module`
--

CREATE TABLE `myopencart_module` (
...
--
-- Dumping data for table `myopencart_module`
--

INSERT INTO `myopencart_module` (`module_id`, `name`, `code`, `setting`) VALUES
...
--
-- Table structure for table `myopencart_notification`
--

CREATE TABLE `myopencart_notification` (
...
--
-- Table structure for table `myopencart_option`
--

CREATE TABLE `myopencart_option` (
...
--
-- Dumping data for table `myopencart_option`
--

INSERT INTO `myopencart_option` (`option_id`, `type`, `validation`, `sort_order`) VALUES
(1, 'radio', NULL, 1),
(2, 'checkbox', NULL, 2),
(4, 'text', NULL, 3),
(5, 'select', NULL, 4),
...
--
-- Table structure for table `myopencart_option_description`
--

CREATE TABLE `myopencart_option_description` (
  `option_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `myopencart_option_description`
--

INSERT INTO `myopencart_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(5, 1, 'Select'),
...
--
-- Table structure for table `myopencart_option_value`
--

CREATE TABLE `myopencart_option_value` (
...
--
-- Dumping data for table `myopencart_option_value`
--

INSERT INTO `myopencart_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(23, 2, '', 1),
(24, 2, '', 2),
(31, 1, '', 2),
(32, 1, '', 1),
...
--
-- Table structure for table `myopencart_option_value_description`
--

CREATE TABLE `myopencart_option_value_description` (
  `option_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `option_id` int(11) DEFAULT NULL,
  `name` varchar(128) DEFAULT NULL
...
--
-- Dumping data for table `myopencart_option_value_description`
--

INSERT INTO `myopencart_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(23, 1, 2, 'Checkbox 1'),
(24, 1, 2, 'Checkbox 2'),
(31, 1, 1, 'Medium'),
(32, 1, 1, 'Small'),
...
--
-- Table structure for table `myopencart_order`
--

CREATE TABLE `myopencart_order` (
...
--
-- Table structure for table `myopencart_order_history`
--

CREATE TABLE `myopencart_order_history` (
...
--
-- Table structure for table `myopencart_order_option`
--

CREATE TABLE `myopencart_order_option` (
...
--
-- Table structure for table `myopencart_order_product`
--

CREATE TABLE `myopencart_order_product` (
...
--
-- Table structure for table `myopencart_order_status`
--

CREATE TABLE `myopencart_order_status` (
...
--
-- Dumping data for table `myopencart_order_status`
--

INSERT INTO `myopencart_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(5, 1, 'Complete'),
...
--
-- Table structure for table `myopencart_order_subscription`
--

CREATE TABLE `myopencart_order_subscription` (
...
--
-- Table structure for table `myopencart_order_total`
--

CREATE TABLE `myopencart_order_total` (
...
--
-- Table structure for table `myopencart_product`
--

CREATE TABLE `myopencart_product` (
  `product_id` int(11) NOT NULL,
  `master_id` int(11) DEFAULT 0,
  `model` varchar(64) DEFAULT NULL,
...
--
-- Table structure for table `myopencart_product_attribute`
--

CREATE TABLE `myopencart_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text DEFAULT NULL
...
--
-- Dumping data for table `myopencart_product_attribute`
--

INSERT INTO `myopencart_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(42, 3, 1, '100mhz'),
(43, 2, 1, '1'),
(43, 4, 1, '8gb'),
(47, 2, 1, '4'),
...
--
-- Table structure for table `myopencart_product_code`
--

CREATE TABLE `myopencart_product_code` (
...
--
-- Table structure for table `myopencart_product_description`
--

CREATE TABLE `myopencart_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `description` text DEFAULT NULL,
...
--
-- Dumping data for table `myopencart_product_description`
--

INSERT INTO `myopencart_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Table structure for table `myopencart_product_discount`
--

CREATE TABLE `myopencart_product_discount` (
...
--
-- Dumping data for table `myopencart_product_discount`
--

INSERT INTO `myopencart_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `type`, `special`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `myopencart_product_filter`
--

CREATE TABLE `myopencart_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_product_image`
--

CREATE TABLE `myopencart_product_image` (
...
--
-- Dumping data for table `myopencart_product_image`
--

INSERT INTO `myopencart_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `myopencart_product_option`
--

CREATE TABLE `myopencart_product_option` (
...
--
-- Dumping data for table `myopencart_product_option`
--

INSERT INTO `myopencart_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(208, 42, 4, 'test', 1),
(209, 42, 6, '', 1),
(217, 42, 5, '', 1),
(218, 42, 1, '', 1),
...
--
-- Table structure for table `myopencart_product_option_value`
--

CREATE TABLE `myopencart_product_option_value` (
...
--
-- Dumping data for table `myopencart_product_option_value`
--

INSERT INTO `myopencart_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Table structure for table `myopencart_product_related`
--

CREATE TABLE `myopencart_product_related` (
  `product_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `myopencart_product_related`
--

INSERT INTO `myopencart_product_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- Table structure for table `myopencart_product_report`
--

CREATE TABLE `myopencart_product_report` (
...
--
-- Table structure for table `myopencart_product_reward`
--

CREATE TABLE `myopencart_product_reward` (
...
--
-- Dumping data for table `myopencart_product_reward`
--

INSERT INTO `myopencart_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(329, 43, 1, 600),
(331, 44, 1, 700),
(333, 45, 1, 800),
(335, 40, 1, 0),
...
--
-- Table structure for table `myopencart_product_subscription`
--

CREATE TABLE `myopencart_product_subscription` (
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `myopencart_product_to_category`
--

CREATE TABLE `myopencart_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `myopencart_product_to_category`
--

INSERT INTO `myopencart_product_to_category` (`product_id`, `category_id`) VALUES
(28, 20),
(28, 24),
(29, 20),
(29, 24),
...
--
-- Table structure for table `myopencart_product_to_download`
--

CREATE TABLE `myopencart_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_product_to_layout`
--

CREATE TABLE `myopencart_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0,
  `layout_id` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_product_to_store`
--

CREATE TABLE `myopencart_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `myopencart_product_to_store`
--

INSERT INTO `myopencart_product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
--
-- Table structure for table `myopencart_product_viewed`
--

CREATE TABLE `myopencart_product_viewed` (
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `myopencart_return`
--

CREATE TABLE `myopencart_return` (
...
--
-- Table structure for table `myopencart_return_action`
--

CREATE TABLE `myopencart_return_action` (
...
--
-- Dumping data for table `myopencart_return_action`
--

INSERT INTO `myopencart_return_action` (`return_action_id`, `language_id`, `name`) VALUES
...
--
-- Table structure for table `myopencart_return_history`
--

CREATE TABLE `myopencart_return_history` (
...
--
-- Table structure for table `myopencart_return_reason`
--

CREATE TABLE `myopencart_return_reason` (
...
--
-- Dumping data for table `myopencart_return_reason`
--

INSERT INTO `myopencart_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
--
-- Table structure for table `myopencart_return_status`
--

CREATE TABLE `myopencart_return_status` (
...
--
-- Dumping data for table `myopencart_return_status`
--

INSERT INTO `myopencart_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
...
--
-- Table structure for table `myopencart_review`
--

CREATE TABLE `myopencart_review` (
...
--
-- Table structure for table `myopencart_seo_url`
--

CREATE TABLE `myopencart_seo_url` (
...
--
-- Dumping data for table `myopencart_seo_url`
--

INSERT INTO `myopencart_seo_url` (`seo_url_id`, `store_id`, `language_id`, `key`, `value`, `keyword`, `sort_order`) VALUES
...
--
-- Table structure for table `myopencart_session`
--

CREATE TABLE `myopencart_session` (
...
--
-- Dumping data for table `myopencart_session`
--

INSERT INTO `myopencart_session` (`session_id`, `data`, `expire`) VALUES
('0bfc7730d0a0cb87ac1e133834', '{\"currency\":\"USD\"}', '2025-06-29 11:43:32'),
('15be3ad7f8612cfa41ed73808a', '{\"user_id\":\"1\",\"user_token\":\"54865376426f48834835f08adc76c7cd\"}', '2025-06-29 11:43:03'),
('e0157e22812d88f9722b3add91', '{\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"f9ee7dbebe760e1cbae7b2c1e9fa806b\",\"login_token\":\"84194e88d4469d9bdeebab62f4be0d41\",\"upload_token\":\"f50f079166f638fe1cec670bc2c9eaa3\",\"review_token\":\"3a2e854d98d6aed5d2d33f3a665a2678\"}', '2025-06-29 11:52:37');

-- --------------------------------------------------------

--
-- Table structure for table `myopencart_setting`
--

CREATE TABLE `myopencart_setting` (
...
--
-- Dumping data for table `myopencart_setting`
--

INSERT INTO `myopencart_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
...
(101, 0, 'config', 'config_email', 'hostbdfree@gmail.com', 0),
...
--
-- Table structure for table `myopencart_startup`
--

CREATE TABLE `myopencart_startup` (
...
--
-- Table structure for table `myopencart_statistics`
--

CREATE TABLE `myopencart_statistics` (
...
--
-- Dumping data for table `myopencart_statistics`
--

INSERT INTO `myopencart_statistics` (`statistics_id`, `code`, `value`) VALUES
(1, 'order_sale', 0.0000),
...
--
-- Table structure for table `myopencart_stock_status`
--

CREATE TABLE `myopencart_stock_status` (
...
--
-- Dumping data for table `myopencart_stock_status`
--

INSERT INTO `myopencart_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(5, 1, 'Out Of Stock'),
(6, 1, '2-3 Days'),
(7, 1, 'In Stock'),
(8, 1, 'Pre-Order');
...
--
-- Table structure for table `myopencart_store`
--

CREATE TABLE `myopencart_store` (
...
--
-- Table structure for table `myopencart_subscription`
--

CREATE TABLE `myopencart_subscription` (
...
--
-- Table structure for table `myopencart_subscription_history`
--

CREATE TABLE `myopencart_subscription_history` (
...
--
-- Table structure for table `myopencart_subscription_log`
--

CREATE TABLE `myopencart_subscription_log` (
...
--
-- Table structure for table `myopencart_subscription_option`
--

CREATE TABLE `myopencart_subscription_option` (
...
--
-- Table structure for table `myopencart_subscription_plan`
--

CREATE TABLE `myopencart_subscription_plan` (
  `subscription_plan_id` int(11) NOT NULL,
  `trial_frequency` enum('day','week','semi_month','month','year') DEFAULT NULL,
...
--
-- Dumping data for table `myopencart_subscription_plan`
--

INSERT INTO `myopencart_subscription_plan` (`subscription_plan_id`, `trial_frequency`, `trial_duration`, `trial_cycle`, `trial_status`, `frequency`, `duration`, `cycle`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `myopencart_subscription_plan_description`
--

CREATE TABLE `myopencart_subscription_plan_description` (
  `subscription_plan_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `myopencart_subscription_plan_description`
--

INSERT INTO `myopencart_subscription_plan_description` (`subscription_plan_id`, `language_id`, `name`) VALUES
(1, 1, 'Daily'),
(2, 1, 'Weekly'),
(3, 1, 'Monthly');
...
--
-- Table structure for table `myopencart_subscription_product`
--

CREATE TABLE `myopencart_subscription_product` (
...
--
-- Table structure for table `myopencart_subscription_status`
--

CREATE TABLE `myopencart_subscription_status` (
...
--
-- Dumping data for table `myopencart_subscription_status`
--

INSERT INTO `myopencart_subscription_status` (`subscription_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(2, 1, 'Active'),
(3, 1, 'Expired'),
(4, 1, 'Suspended'),
...
--
-- Table structure for table `myopencart_tax_class`
--

CREATE TABLE `myopencart_tax_class` (
...
--
-- Dumping data for table `myopencart_tax_class`
--

INSERT INTO `myopencart_tax_class` (`tax_class_id`, `title`, `description`) VALUES
...
--
-- Table structure for table `myopencart_tax_rate`
--

CREATE TABLE `myopencart_tax_rate` (
...
--
-- Dumping data for table `myopencart_tax_rate`
--

INSERT INTO `myopencart_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`) VALUES
...
--
-- Table structure for table `myopencart_tax_rate_to_customer_group`
--

CREATE TABLE `myopencart_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `myopencart_tax_rate_to_customer_group`
--

INSERT INTO `myopencart_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Table structure for table `myopencart_tax_rule`
--

CREATE TABLE `myopencart_tax_rule` (
...
--
-- Dumping data for table `myopencart_tax_rule`
--

INSERT INTO `myopencart_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(120, 10, 87, 'store', 0),
(121, 10, 86, 'payment', 1),
(127, 9, 87, 'shipping', 2),
(128, 9, 86, 'shipping', 1);
...
--
-- Table structure for table `myopencart_theme`
--

CREATE TABLE `myopencart_theme` (
...
--
-- Table structure for table `myopencart_topic`
--

CREATE TABLE `myopencart_topic` (
...
--
-- Table structure for table `myopencart_topic_description`
--

CREATE TABLE `myopencart_topic_description` (
  `topic_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `description` text DEFAULT NULL,
...
--
-- Table structure for table `myopencart_topic_to_layout`
--

CREATE TABLE `myopencart_topic_to_layout` (
  `topic_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0,
  `layout_id` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_topic_to_store`
--

CREATE TABLE `myopencart_topic_to_store` (
  `topic_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `myopencart_translation`
--

CREATE TABLE `myopencart_translation` (
...
--
-- Table structure for table `myopencart_upload`
--

CREATE TABLE `myopencart_upload` (
...
--
-- Table structure for table `myopencart_user`
--

CREATE TABLE `myopencart_user` (
...
--
-- Dumping data for table `myopencart_user`
--

INSERT INTO `myopencart_user` (`user_id`, `user_group_id`, `username`, `password`, `firstname`, `lastname`, `email`, `image`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'admin', '$2y$10$kFaSnlSz0ZTCli3ZH3Sk4.ExHQyuwwDWeF3DpTBnTQpqqFGuHwPai', 'John', 'Doe', 'hostbdfree@gmail.com', '', '103.137.161.4', 1, '[[time_now]]');

-- --------------------------------------------------------

--
-- Table structure for table `myopencart_user_authorize`
--

CREATE TABLE `myopencart_user_authorize` (
...
--
-- Table structure for table `myopencart_user_group`
--

CREATE TABLE `myopencart_user_group` (
...
--
-- Dumping data for table `myopencart_user_group`
--

INSERT INTO `myopencart_user_group` (`user_group_id`, `name`, `permission`) VALUES
...
--
-- Table structure for table `myopencart_user_login`
--

CREATE TABLE `myopencart_user_login` (
...
--
-- Dumping data for table `myopencart_user_login`
--

INSERT INTO `myopencart_user_login` (`user_login_id`, `user_id`, `ip`, `user_agent`, `date_added`) VALUES
(1, 1, '103.137.161.4', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', '2025-06-28 11:43:00'),
(2, 1, '103.137.161.4', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', '2025-06-28 11:47:02');

-- --------------------------------------------------------

--
-- Table structure for table `myopencart_user_token`
--

CREATE TABLE `myopencart_user_token` (
...
--
-- Table structure for table `myopencart_weight_class`
--

CREATE TABLE `myopencart_weight_class` (
  `weight_class_id` int(11) NOT NULL,
  `value` decimal(15,8) DEFAULT 0.00000000
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `myopencart_weight_class`
--

INSERT INTO `myopencart_weight_class` (`weight_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 1000.00000000),
(3, 2.20460000),
(4, 35.27400000);
...
--
-- Table structure for table `myopencart_weight_class_description`
--

CREATE TABLE `myopencart_weight_class_description` (
  `weight_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) DEFAULT NULL,
  `unit` varchar(4) DEFAULT NULL
...
--
-- Dumping data for table `myopencart_weight_class_description`
--

INSERT INTO `myopencart_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(3, 1, 'Pound ', 'lb'),
(4, 1, 'Ounce', 'oz');
...
--
-- Table structure for table `myopencart_zone`
--

CREATE TABLE `myopencart_zone` (
...
--
-- Dumping data for table `myopencart_zone`
--

INSERT INTO `myopencart_zone` (`zone_id`, `country_id`, `code`, `status`) VALUES
(1, 1, 'BDS', 1),
(2, 1, 'BDG', 1),
(3, 1, 'BGL', 1),
(4, 1, 'BAL', 1),
...
--
-- Table structure for table `myopencart_zone_description`
--

CREATE TABLE `myopencart_zone_description` (
  `zone_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `myopencart_zone_description`
--

INSERT INTO `myopencart_zone_description` (`zone_id`, `language_id`, `name`) VALUES
(3507, 1, '\'Ajman'),
(919, 1, '\'Ali Sabih'),
(1704, 1, '\'Amman'),
(2881, 1, '\'Asir'),
...
--
-- Table structure for table `myopencart_zone_to_geo_zone`
--

CREATE TABLE `myopencart_zone_to_geo_zone` (
...
--
-- Dumping data for table `myopencart_zone_to_geo_zone`
--

INSERT INTO `myopencart_zone_to_geo_zone` (`zone_to_geo_zone_id`, `geo_zone_id`, `country_id`, `zone_id`) VALUES
(1, 4, 222, 0),
(2, 3, 222, 3513),
(3, 3, 222, 3514),
(4, 3, 222, 3515),
...
--
-- Indexes for table `myopencart_address`
--
ALTER TABLE `myopencart_address`
  ADD PRIMARY KEY (`address_id`),
  ADD KEY `customer_id` (`customer_id`);

--
-- Indexes for table `myopencart_address_format`
--
ALTER TABLE `myopencart_address_format`
  ADD PRIMARY KEY (`address_format_id`);

--
-- Indexes for table `myopencart_antispam`
--
ALTER TABLE `myopencart_antispam`
  ADD PRIMARY KEY (`antispam_id`),
  ADD KEY `keyword` (`keyword`);

--
-- Indexes for table `myopencart_api`
--
ALTER TABLE `myopencart_api`
  ADD PRIMARY KEY (`api_id`);

--
-- Indexes for table `myopencart_api_history`
--
ALTER TABLE `myopencart_api_history`
  ADD PRIMARY KEY (`api_history_id`);

--
-- Indexes for table `myopencart_api_ip`
--
ALTER TABLE `myopencart_api_ip`
  ADD PRIMARY KEY (`api_ip_id`);

--
-- Indexes for table `myopencart_article`
--
ALTER TABLE `myopencart_article`
  ADD PRIMARY KEY (`article_id`);

--
-- Indexes for table `myopencart_article_comment`
--
ALTER TABLE `myopencart_article_comment`
...
--
-- Indexes for table `myopencart_article_description`
--
ALTER TABLE `myopencart_article_description`
  ADD PRIMARY KEY (`article_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `myopencart_article_rating`
--
ALTER TABLE `myopencart_article_rating`
...
--
-- Indexes for table `myopencart_article_to_layout`
--
ALTER TABLE `myopencart_article_to_layout`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Indexes for table `myopencart_article_to_store`
--
ALTER TABLE `myopencart_article_to_store`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Indexes for table `myopencart_attribute`
--
ALTER TABLE `myopencart_attribute`
  ADD PRIMARY KEY (`attribute_id`);

--
-- Indexes for table `myopencart_attribute_description`
--
ALTER TABLE `myopencart_attribute_description`
  ADD PRIMARY KEY (`attribute_id`,`language_id`);

--
-- Indexes for table `myopencart_attribute_group`
--
ALTER TABLE `myopencart_attribute_group`
  ADD PRIMARY KEY (`attribute_group_id`);

--
-- Indexes for table `myopencart_attribute_group_description`
--
ALTER TABLE `myopencart_attribute_group_description`
  ADD PRIMARY KEY (`attribute_group_id`,`language_id`);

--
-- Indexes for table `myopencart_banner`
--
ALTER TABLE `myopencart_banner`
  ADD PRIMARY KEY (`banner_id`);

--
-- Indexes for table `myopencart_banner_image`
--
ALTER TABLE `myopencart_banner_image`
  ADD PRIMARY KEY (`banner_image_id`);

--
-- Indexes for table `myopencart_cart`
--
ALTER TABLE `myopencart_cart`
  ADD PRIMARY KEY (`cart_id`),
  ADD KEY `cart_id` (`customer_id`,`session_id`,`product_id`,`subscription_plan_id`);

--
-- Indexes for table `myopencart_category`
--
ALTER TABLE `myopencart_category`
  ADD PRIMARY KEY (`category_id`),
  ADD KEY `parent_id` (`parent_id`);

--
-- Indexes for table `myopencart_category_description`
--
ALTER TABLE `myopencart_category_description`
  ADD PRIMARY KEY (`category_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `myopencart_category_filter`
--
ALTER TABLE `myopencart_category_filter`
  ADD PRIMARY KEY (`category_id`,`filter_id`);

--
-- Indexes for table `myopencart_category_path`
--
ALTER TABLE `myopencart_category_path`
  ADD PRIMARY KEY (`category_id`,`path_id`);

--
-- Indexes for table `myopencart_category_to_layout`
--
ALTER TABLE `myopencart_category_to_layout`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `myopencart_category_to_store`
--
ALTER TABLE `myopencart_category_to_store`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `myopencart_country`
--
ALTER TABLE `myopencart_country`
  ADD PRIMARY KEY (`country_id`);

--
-- Indexes for table `myopencart_country_description`
--
ALTER TABLE `myopencart_country_description`
  ADD PRIMARY KEY (`country_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `myopencart_coupon`
--
ALTER TABLE `myopencart_coupon`
  ADD PRIMARY KEY (`coupon_id`);

--
-- Indexes for table `myopencart_coupon_category`
--
ALTER TABLE `myopencart_coupon_category`
  ADD PRIMARY KEY (`coupon_id`,`category_id`);

--
-- Indexes for table `myopencart_coupon_history`
--
ALTER TABLE `myopencart_coupon_history`
  ADD PRIMARY KEY (`coupon_history_id`);

--
-- Indexes for table `myopencart_coupon_product`
--
ALTER TABLE `myopencart_coupon_product`
  ADD PRIMARY KEY (`coupon_product_id`);

--
-- Indexes for table `myopencart_cron`
--
ALTER TABLE `myopencart_cron`
  ADD PRIMARY KEY (`cron_id`);

--
-- Indexes for table `myopencart_currency`
--
ALTER TABLE `myopencart_currency`
  ADD PRIMARY KEY (`currency_id`);

--
-- Indexes for table `myopencart_customer`
--
ALTER TABLE `myopencart_customer`
  ADD PRIMARY KEY (`customer_id`),
  ADD KEY `email` (`email`);

--
-- Indexes for table `myopencart_customer_activity`
--
ALTER TABLE `myopencart_customer_activity`
  ADD PRIMARY KEY (`customer_activity_id`);

--
-- Indexes for table `myopencart_customer_affiliate`
--
ALTER TABLE `myopencart_customer_affiliate`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indexes for table `myopencart_customer_affiliate_report`
--
ALTER TABLE `myopencart_customer_affiliate_report`
  ADD PRIMARY KEY (`customer_affiliate_report_id`);

--
-- Indexes for table `myopencart_customer_approval`
--
ALTER TABLE `myopencart_customer_approval`
  ADD PRIMARY KEY (`customer_approval_id`);

--
-- Indexes for table `myopencart_customer_authorize`
--
ALTER TABLE `myopencart_customer_authorize`
  ADD PRIMARY KEY (`customer_authorize_id`);

--
-- Indexes for table `myopencart_customer_group`
--
ALTER TABLE `myopencart_customer_group`
  ADD PRIMARY KEY (`customer_group_id`);

--
-- Indexes for table `myopencart_customer_group_description`
--
ALTER TABLE `myopencart_customer_group_description`
  ADD PRIMARY KEY (`customer_group_id`,`language_id`);

--
-- Indexes for table `myopencart_customer_history`
--
ALTER TABLE `myopencart_customer_history`
  ADD PRIMARY KEY (`customer_history_id`);

--
-- Indexes for table `myopencart_customer_ip`
--
ALTER TABLE `myopencart_customer_ip`
  ADD PRIMARY KEY (`customer_ip_id`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `myopencart_customer_login`
--
ALTER TABLE `myopencart_customer_login`
  ADD PRIMARY KEY (`customer_login_id`),
  ADD KEY `email` (`email`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `myopencart_customer_online`
--
ALTER TABLE `myopencart_customer_online`
  ADD PRIMARY KEY (`ip`);

--
-- Indexes for table `myopencart_customer_reward`
--
ALTER TABLE `myopencart_customer_reward`
  ADD PRIMARY KEY (`customer_reward_id`);

--
-- Indexes for table `myopencart_customer_search`
--
ALTER TABLE `myopencart_customer_search`
  ADD PRIMARY KEY (`customer_search_id`);

--
-- Indexes for table `myopencart_customer_token`
--
ALTER TABLE `myopencart_customer_token`
  ADD PRIMARY KEY (`customer_token_id`);

--
-- Indexes for table `myopencart_customer_transaction`
--
ALTER TABLE `myopencart_customer_transaction`
  ADD PRIMARY KEY (`customer_transaction_id`);

--
-- Indexes for table `myopencart_customer_wishlist`
--
ALTER TABLE `myopencart_customer_wishlist`
  ADD PRIMARY KEY (`customer_id`,`store_id`,`product_id`);

--
-- Indexes for table `myopencart_custom_field`
--
ALTER TABLE `myopencart_custom_field`
  ADD PRIMARY KEY (`custom_field_id`);

--
-- Indexes for table `myopencart_custom_field_customer_group`
--
ALTER TABLE `myopencart_custom_field_customer_group`
  ADD PRIMARY KEY (`custom_field_id`,`customer_group_id`);

--
-- Indexes for table `myopencart_custom_field_description`
--
ALTER TABLE `myopencart_custom_field_description`
  ADD PRIMARY KEY (`custom_field_id`,`language_id`);

--
-- Indexes for table `myopencart_custom_field_value`
--
ALTER TABLE `myopencart_custom_field_value`
  ADD PRIMARY KEY (`custom_field_value_id`);

--
-- Indexes for table `myopencart_custom_field_value_description`
--
ALTER TABLE `myopencart_custom_field_value_description`
  ADD PRIMARY KEY (`custom_field_value_id`,`language_id`);

--
-- Indexes for table `myopencart_download`
--
ALTER TABLE `myopencart_download`
  ADD PRIMARY KEY (`download_id`);

--
-- Indexes for table `myopencart_download_description`
--
ALTER TABLE `myopencart_download_description`
  ADD PRIMARY KEY (`download_id`,`language_id`);

--
-- Indexes for table `myopencart_download_report`
--
ALTER TABLE `myopencart_download_report`
  ADD PRIMARY KEY (`download_report_id`);

--
-- Indexes for table `myopencart_event`
--
ALTER TABLE `myopencart_event`
  ADD PRIMARY KEY (`event_id`);

--
-- Indexes for table `myopencart_extension`
--
ALTER TABLE `myopencart_extension`
  ADD PRIMARY KEY (`extension_id`);

--
-- Indexes for table `myopencart_extension_install`
--
ALTER TABLE `myopencart_extension_install`
  ADD PRIMARY KEY (`extension_install_id`);

--
-- Indexes for table `myopencart_extension_path`
--
ALTER TABLE `myopencart_extension_path`
  ADD PRIMARY KEY (`extension_path_id`),
  ADD KEY `path` (`path`);

--
-- Indexes for table `myopencart_filter`
--
ALTER TABLE `myopencart_filter`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `myopencart_filter_description`
--
ALTER TABLE `myopencart_filter_description`
  ADD PRIMARY KEY (`filter_id`,`language_id`);

--
-- Indexes for table `myopencart_filter_group`
--
ALTER TABLE `myopencart_filter_group`
  ADD PRIMARY KEY (`filter_group_id`);

--
-- Indexes for table `myopencart_filter_group_description`
--
ALTER TABLE `myopencart_filter_group_description`
  ADD PRIMARY KEY (`filter_group_id`,`language_id`);

--
-- Indexes for table `myopencart_gdpr`
--
ALTER TABLE `myopencart_gdpr`
  ADD PRIMARY KEY (`gdpr_id`);

--
-- Indexes for table `myopencart_geo_zone`
--
ALTER TABLE `myopencart_geo_zone`
  ADD PRIMARY KEY (`geo_zone_id`);

--
-- Indexes for table `myopencart_identifier`
--
ALTER TABLE `myopencart_identifier`
  ADD PRIMARY KEY (`identifier_id`);

--
-- Indexes for table `myopencart_information`
--
ALTER TABLE `myopencart_information`
  ADD PRIMARY KEY (`information_id`);

--
-- Indexes for table `myopencart_information_description`
--
ALTER TABLE `myopencart_information_description`
  ADD PRIMARY KEY (`information_id`,`language_id`);

--
-- Indexes for table `myopencart_information_to_layout`
--
ALTER TABLE `myopencart_information_to_layout`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indexes for table `myopencart_information_to_store`
--
ALTER TABLE `myopencart_information_to_store`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indexes for table `myopencart_language`
--
ALTER TABLE `myopencart_language`
  ADD PRIMARY KEY (`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `myopencart_layout`
--
ALTER TABLE `myopencart_layout`
  ADD PRIMARY KEY (`layout_id`);

--
-- Indexes for table `myopencart_layout_module`
--
ALTER TABLE `myopencart_layout_module`
  ADD PRIMARY KEY (`layout_module_id`);

--
-- Indexes for table `myopencart_layout_route`
--
ALTER TABLE `myopencart_layout_route`
  ADD PRIMARY KEY (`layout_route_id`);

--
-- Indexes for table `myopencart_length_class`
--
ALTER TABLE `myopencart_length_class`
  ADD PRIMARY KEY (`length_class_id`);

--
-- Indexes for table `myopencart_length_class_description`
--
ALTER TABLE `myopencart_length_class_description`
  ADD PRIMARY KEY (`length_class_id`,`language_id`);

--
-- Indexes for table `myopencart_location`
--
ALTER TABLE `myopencart_location`
  ADD PRIMARY KEY (`location_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `myopencart_manufacturer`
--
ALTER TABLE `myopencart_manufacturer`
  ADD PRIMARY KEY (`manufacturer_id`);

--
-- Indexes for table `myopencart_manufacturer_to_layout`
--
ALTER TABLE `myopencart_manufacturer_to_layout`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Indexes for table `myopencart_manufacturer_to_store`
--
ALTER TABLE `myopencart_manufacturer_to_store`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Indexes for table `myopencart_marketing`
--
ALTER TABLE `myopencart_marketing`
  ADD PRIMARY KEY (`marketing_id`);

--
-- Indexes for table `myopencart_marketing_report`
--
ALTER TABLE `myopencart_marketing_report`
  ADD PRIMARY KEY (`marketing_report_id`);

--
-- Indexes for table `myopencart_modification`
--
ALTER TABLE `myopencart_modification`
  ADD PRIMARY KEY (`modification_id`);

--
-- Indexes for table `myopencart_module`
--
ALTER TABLE `myopencart_module`
  ADD PRIMARY KEY (`module_id`);

--
-- Indexes for table `myopencart_notification`
--
ALTER TABLE `myopencart_notification`
  ADD PRIMARY KEY (`notification_id`);

--
-- Indexes for table `myopencart_option`
--
ALTER TABLE `myopencart_option`
  ADD PRIMARY KEY (`option_id`);

--
-- Indexes for table `myopencart_option_description`
--
ALTER TABLE `myopencart_option_description`
  ADD PRIMARY KEY (`option_id`,`language_id`);

--
-- Indexes for table `myopencart_option_value`
--
ALTER TABLE `myopencart_option_value`
  ADD PRIMARY KEY (`option_value_id`);

--
-- Indexes for table `myopencart_option_value_description`
--
ALTER TABLE `myopencart_option_value_description`
  ADD PRIMARY KEY (`option_value_id`,`language_id`);

--
-- Indexes for table `myopencart_order`
--
ALTER TABLE `myopencart_order`
  ADD PRIMARY KEY (`order_id`),
  ADD KEY `email` (`email`);

--
-- Indexes for table `myopencart_order_history`
--
ALTER TABLE `myopencart_order_history`
  ADD PRIMARY KEY (`order_history_id`);

--
-- Indexes for table `myopencart_order_option`
--
ALTER TABLE `myopencart_order_option`
  ADD PRIMARY KEY (`order_option_id`);

--
-- Indexes for table `myopencart_order_product`
--
ALTER TABLE `myopencart_order_product`
  ADD PRIMARY KEY (`order_product_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `myopencart_order_status`
--
ALTER TABLE `myopencart_order_status`
  ADD PRIMARY KEY (`order_status_id`,`language_id`);

--
-- Indexes for table `myopencart_order_subscription`
--
ALTER TABLE `myopencart_order_subscription`
  ADD PRIMARY KEY (`order_subscription_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `myopencart_order_total`
--
ALTER TABLE `myopencart_order_total`
  ADD PRIMARY KEY (`order_total_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `myopencart_product`
--
ALTER TABLE `myopencart_product`
  ADD PRIMARY KEY (`product_id`);

--
-- Indexes for table `myopencart_product_attribute`
--
ALTER TABLE `myopencart_product_attribute`
  ADD PRIMARY KEY (`product_id`,`attribute_id`,`language_id`);

--
-- Indexes for table `myopencart_product_code`
--
ALTER TABLE `myopencart_product_code`
  ADD PRIMARY KEY (`product_code_id`),
  ADD KEY `code` (`code`);

--
-- Indexes for table `myopencart_product_description`
--
ALTER TABLE `myopencart_product_description`
  ADD PRIMARY KEY (`product_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `myopencart_product_discount`
--
ALTER TABLE `myopencart_product_discount`
  ADD PRIMARY KEY (`product_discount_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `myopencart_product_filter`
--
ALTER TABLE `myopencart_product_filter`
  ADD PRIMARY KEY (`product_id`,`filter_id`);

--
-- Indexes for table `myopencart_product_image`
--
ALTER TABLE `myopencart_product_image`
  ADD PRIMARY KEY (`product_image_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `myopencart_product_option`
--
ALTER TABLE `myopencart_product_option`
  ADD PRIMARY KEY (`product_option_id`);

--
-- Indexes for table `myopencart_product_option_value`
--
ALTER TABLE `myopencart_product_option_value`
  ADD PRIMARY KEY (`product_option_value_id`);

--
-- Indexes for table `myopencart_product_related`
--
ALTER TABLE `myopencart_product_related`
  ADD PRIMARY KEY (`product_id`,`related_id`);

--
-- Indexes for table `myopencart_product_report`
--
ALTER TABLE `myopencart_product_report`
  ADD PRIMARY KEY (`product_report_id`);

--
-- Indexes for table `myopencart_product_reward`
--
ALTER TABLE `myopencart_product_reward`
  ADD PRIMARY KEY (`product_reward_id`);

--
-- Indexes for table `myopencart_product_subscription`
--
ALTER TABLE `myopencart_product_subscription`
  ADD PRIMARY KEY (`product_id`,`subscription_plan_id`,`customer_group_id`);

--
-- Indexes for table `myopencart_product_to_category`
--
ALTER TABLE `myopencart_product_to_category`
  ADD PRIMARY KEY (`product_id`,`category_id`),
  ADD KEY `category_id` (`category_id`);

--
-- Indexes for table `myopencart_product_to_download`
--
ALTER TABLE `myopencart_product_to_download`
  ADD PRIMARY KEY (`product_id`,`download_id`);

--
-- Indexes for table `myopencart_product_to_layout`
--
ALTER TABLE `myopencart_product_to_layout`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `myopencart_product_to_store`
--
ALTER TABLE `myopencart_product_to_store`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `myopencart_product_viewed`
--
ALTER TABLE `myopencart_product_viewed`
  ADD PRIMARY KEY (`product_id`);

--
-- Indexes for table `myopencart_return`
--
ALTER TABLE `myopencart_return`
  ADD PRIMARY KEY (`return_id`);

--
-- Indexes for table `myopencart_return_action`
--
ALTER TABLE `myopencart_return_action`
  ADD PRIMARY KEY (`return_action_id`,`language_id`);

--
-- Indexes for table `myopencart_return_history`
--
ALTER TABLE `myopencart_return_history`
  ADD PRIMARY KEY (`return_history_id`);

--
-- Indexes for table `myopencart_return_reason`
--
ALTER TABLE `myopencart_return_reason`
  ADD PRIMARY KEY (`return_reason_id`,`language_id`);

--
-- Indexes for table `myopencart_return_status`
--
ALTER TABLE `myopencart_return_status`
  ADD PRIMARY KEY (`return_status_id`,`language_id`);

--
-- Indexes for table `myopencart_review`
--
ALTER TABLE `myopencart_review`
  ADD PRIMARY KEY (`review_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `myopencart_seo_url`
--
ALTER TABLE `myopencart_seo_url`
...
--
-- Indexes for table `myopencart_session`
--
ALTER TABLE `myopencart_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `expire` (`expire`);

--
-- Indexes for table `myopencart_setting`
--
ALTER TABLE `myopencart_setting`
  ADD PRIMARY KEY (`setting_id`);

--
-- Indexes for table `myopencart_startup`
--
ALTER TABLE `myopencart_startup`
  ADD PRIMARY KEY (`startup_id`);

--
-- Indexes for table `myopencart_statistics`
--
ALTER TABLE `myopencart_statistics`
  ADD PRIMARY KEY (`statistics_id`);

--
-- Indexes for table `myopencart_stock_status`
--
ALTER TABLE `myopencart_stock_status`
  ADD PRIMARY KEY (`stock_status_id`,`language_id`);

--
-- Indexes for table `myopencart_store`
--
ALTER TABLE `myopencart_store`
  ADD PRIMARY KEY (`store_id`);

--
-- Indexes for table `myopencart_subscription`
--
ALTER TABLE `myopencart_subscription`
  ADD PRIMARY KEY (`subscription_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `myopencart_subscription_history`
--
ALTER TABLE `myopencart_subscription_history`
  ADD PRIMARY KEY (`subscription_history_id`);

--
-- Indexes for table `myopencart_subscription_log`
--
ALTER TABLE `myopencart_subscription_log`
  ADD PRIMARY KEY (`subscription_log_id`);

--
-- Indexes for table `myopencart_subscription_option`
--
ALTER TABLE `myopencart_subscription_option`
  ADD PRIMARY KEY (`subscription_option_id`);

--
-- Indexes for table `myopencart_subscription_plan`
--
ALTER TABLE `myopencart_subscription_plan`
  ADD PRIMARY KEY (`subscription_plan_id`);

--
-- Indexes for table `myopencart_subscription_plan_description`
--
ALTER TABLE `myopencart_subscription_plan_description`
  ADD PRIMARY KEY (`subscription_plan_id`,`language_id`);

--
-- Indexes for table `myopencart_subscription_product`
--
ALTER TABLE `myopencart_subscription_product`
  ADD PRIMARY KEY (`subscription_product_id`),
  ADD KEY `subscription_id` (`subscription_id`);

--
-- Indexes for table `myopencart_subscription_status`
--
ALTER TABLE `myopencart_subscription_status`
  ADD PRIMARY KEY (`subscription_status_id`,`language_id`);

--
-- Indexes for table `myopencart_tax_class`
--
ALTER TABLE `myopencart_tax_class`
  ADD PRIMARY KEY (`tax_class_id`);

--
-- Indexes for table `myopencart_tax_rate`
--
ALTER TABLE `myopencart_tax_rate`
  ADD PRIMARY KEY (`tax_rate_id`);

--
-- Indexes for table `myopencart_tax_rate_to_customer_group`
--
ALTER TABLE `myopencart_tax_rate_to_customer_group`
  ADD PRIMARY KEY (`tax_rate_id`,`customer_group_id`);

--
-- Indexes for table `myopencart_tax_rule`
--
ALTER TABLE `myopencart_tax_rule`
  ADD PRIMARY KEY (`tax_rule_id`);

--
-- Indexes for table `myopencart_theme`
--
ALTER TABLE `myopencart_theme`
  ADD PRIMARY KEY (`theme_id`);

--
-- Indexes for table `myopencart_topic`
--
ALTER TABLE `myopencart_topic`
  ADD PRIMARY KEY (`topic_id`);

--
-- Indexes for table `myopencart_topic_description`
--
ALTER TABLE `myopencart_topic_description`
  ADD PRIMARY KEY (`topic_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `myopencart_topic_to_layout`
--
ALTER TABLE `myopencart_topic_to_layout`
  ADD PRIMARY KEY (`topic_id`,`store_id`);

--
-- Indexes for table `myopencart_topic_to_store`
--
ALTER TABLE `myopencart_topic_to_store`
  ADD PRIMARY KEY (`topic_id`,`store_id`);

--
-- Indexes for table `myopencart_translation`
--
ALTER TABLE `myopencart_translation`
  ADD PRIMARY KEY (`translation_id`);

--
-- Indexes for table `myopencart_upload`
--
ALTER TABLE `myopencart_upload`
  ADD PRIMARY KEY (`upload_id`);

--
-- Indexes for table `myopencart_user`
--
ALTER TABLE `myopencart_user`
  ADD PRIMARY KEY (`user_id`);

--
-- Indexes for table `myopencart_user_authorize`
--
ALTER TABLE `myopencart_user_authorize`
  ADD PRIMARY KEY (`user_authorize_id`);

--
-- Indexes for table `myopencart_user_group`
--
ALTER TABLE `myopencart_user_group`
  ADD PRIMARY KEY (`user_group_id`);

--
-- Indexes for table `myopencart_user_login`
--
ALTER TABLE `myopencart_user_login`
  ADD PRIMARY KEY (`user_login_id`);

--
-- Indexes for table `myopencart_user_token`
--
ALTER TABLE `myopencart_user_token`
  ADD PRIMARY KEY (`user_token_id`);

--
-- Indexes for table `myopencart_weight_class`
--
ALTER TABLE `myopencart_weight_class`
  ADD PRIMARY KEY (`weight_class_id`);

--
-- Indexes for table `myopencart_weight_class_description`
--
ALTER TABLE `myopencart_weight_class_description`
  ADD PRIMARY KEY (`weight_class_id`,`language_id`);

--
-- Indexes for table `myopencart_zone`
--
ALTER TABLE `myopencart_zone`
  ADD PRIMARY KEY (`zone_id`);

--
-- Indexes for table `myopencart_zone_description`
--
ALTER TABLE `myopencart_zone_description`
  ADD PRIMARY KEY (`zone_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `myopencart_zone_to_geo_zone`
--
ALTER TABLE `myopencart_zone_to_geo_zone`
...
--
-- AUTO_INCREMENT for table `myopencart_address`
--
ALTER TABLE `myopencart_address`
  MODIFY `address_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_address_format`
--
ALTER TABLE `myopencart_address_format`
  MODIFY `address_format_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `myopencart_antispam`
--
ALTER TABLE `myopencart_antispam`
  MODIFY `antispam_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_api`
--
ALTER TABLE `myopencart_api`
  MODIFY `api_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `myopencart_api_history`
--
ALTER TABLE `myopencart_api_history`
  MODIFY `api_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_api_ip`
--
ALTER TABLE `myopencart_api_ip`
  MODIFY `api_ip_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_article`
--
ALTER TABLE `myopencart_article`
  MODIFY `article_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_article_comment`
--
ALTER TABLE `myopencart_article_comment`
  MODIFY `article_comment_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_article_rating`
--
ALTER TABLE `myopencart_article_rating`
  MODIFY `article_rating_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_attribute`
--
ALTER TABLE `myopencart_attribute`
  MODIFY `attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `myopencart_attribute_group`
--
ALTER TABLE `myopencart_attribute_group`
  MODIFY `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `myopencart_banner`
--
ALTER TABLE `myopencart_banner`
  MODIFY `banner_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `myopencart_banner_image`
--
ALTER TABLE `myopencart_banner_image`
  MODIFY `banner_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;

--
-- AUTO_INCREMENT for table `myopencart_cart`
--
ALTER TABLE `myopencart_cart`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_category`
--
ALTER TABLE `myopencart_category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `myopencart_country`
--
ALTER TABLE `myopencart_country`
  MODIFY `country_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=258;

--
-- AUTO_INCREMENT for table `myopencart_coupon`
--
ALTER TABLE `myopencart_coupon`
  MODIFY `coupon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `myopencart_coupon_history`
--
ALTER TABLE `myopencart_coupon_history`
  MODIFY `coupon_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_coupon_product`
--
ALTER TABLE `myopencart_coupon_product`
  MODIFY `coupon_product_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_cron`
--
ALTER TABLE `myopencart_cron`
  MODIFY `cron_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `myopencart_currency`
--
ALTER TABLE `myopencart_currency`
  MODIFY `currency_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `myopencart_customer`
--
ALTER TABLE `myopencart_customer`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_customer_activity`
--
ALTER TABLE `myopencart_customer_activity`
  MODIFY `customer_activity_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_customer_affiliate_report`
--
ALTER TABLE `myopencart_customer_affiliate_report`
  MODIFY `customer_affiliate_report_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_customer_approval`
--
ALTER TABLE `myopencart_customer_approval`
  MODIFY `customer_approval_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_customer_authorize`
--
ALTER TABLE `myopencart_customer_authorize`
  MODIFY `customer_authorize_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_customer_group`
--
ALTER TABLE `myopencart_customer_group`
  MODIFY `customer_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `myopencart_customer_history`
--
ALTER TABLE `myopencart_customer_history`
  MODIFY `customer_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_customer_ip`
--
ALTER TABLE `myopencart_customer_ip`
  MODIFY `customer_ip_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_customer_login`
--
ALTER TABLE `myopencart_customer_login`
  MODIFY `customer_login_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_customer_reward`
--
ALTER TABLE `myopencart_customer_reward`
  MODIFY `customer_reward_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_customer_search`
--
ALTER TABLE `myopencart_customer_search`
  MODIFY `customer_search_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_customer_token`
--
ALTER TABLE `myopencart_customer_token`
  MODIFY `customer_token_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_customer_transaction`
--
ALTER TABLE `myopencart_customer_transaction`
  MODIFY `customer_transaction_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_custom_field`
--
ALTER TABLE `myopencart_custom_field`
  MODIFY `custom_field_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `myopencart_custom_field_value`
--
ALTER TABLE `myopencart_custom_field_value`
  MODIFY `custom_field_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT for table `myopencart_download`
--
ALTER TABLE `myopencart_download`
  MODIFY `download_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_download_report`
--
ALTER TABLE `myopencart_download_report`
  MODIFY `download_report_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_event`
--
ALTER TABLE `myopencart_event`
  MODIFY `event_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `myopencart_extension`
--
ALTER TABLE `myopencart_extension`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT for table `myopencart_extension_install`
--
ALTER TABLE `myopencart_extension_install`
  MODIFY `extension_install_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `myopencart_extension_path`
--
ALTER TABLE `myopencart_extension_path`
  MODIFY `extension_path_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=396;

--
-- AUTO_INCREMENT for table `myopencart_filter`
--
ALTER TABLE `myopencart_filter`
  MODIFY `filter_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_filter_group`
--
ALTER TABLE `myopencart_filter_group`
  MODIFY `filter_group_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_gdpr`
--
ALTER TABLE `myopencart_gdpr`
  MODIFY `gdpr_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_geo_zone`
--
ALTER TABLE `myopencart_geo_zone`
  MODIFY `geo_zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `myopencart_identifier`
--
ALTER TABLE `myopencart_identifier`
  MODIFY `identifier_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `myopencart_information`
--
ALTER TABLE `myopencart_information`
  MODIFY `information_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `myopencart_language`
--
ALTER TABLE `myopencart_language`
  MODIFY `language_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `myopencart_layout`
--
ALTER TABLE `myopencart_layout`
  MODIFY `layout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `myopencart_layout_module`
--
ALTER TABLE `myopencart_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `myopencart_layout_route`
--
ALTER TABLE `myopencart_layout_route`
  MODIFY `layout_route_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `myopencart_length_class`
--
ALTER TABLE `myopencart_length_class`
  MODIFY `length_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `myopencart_location`
--
ALTER TABLE `myopencart_location`
  MODIFY `location_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_manufacturer`
--
ALTER TABLE `myopencart_manufacturer`
  MODIFY `manufacturer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `myopencart_marketing`
--
ALTER TABLE `myopencart_marketing`
  MODIFY `marketing_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_marketing_report`
--
ALTER TABLE `myopencart_marketing_report`
  MODIFY `marketing_report_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_modification`
--
ALTER TABLE `myopencart_modification`
  MODIFY `modification_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_module`
--
ALTER TABLE `myopencart_module`
  MODIFY `module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `myopencart_notification`
--
ALTER TABLE `myopencart_notification`
  MODIFY `notification_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_option`
--
ALTER TABLE `myopencart_option`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `myopencart_option_value`
--
ALTER TABLE `myopencart_option_value`
  MODIFY `option_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `myopencart_order`
--
ALTER TABLE `myopencart_order`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_order_history`
--
ALTER TABLE `myopencart_order_history`
  MODIFY `order_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_order_option`
--
ALTER TABLE `myopencart_order_option`
  MODIFY `order_option_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_order_product`
--
ALTER TABLE `myopencart_order_product`
  MODIFY `order_product_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_order_status`
--
ALTER TABLE `myopencart_order_status`
  MODIFY `order_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `myopencart_order_subscription`
--
ALTER TABLE `myopencart_order_subscription`
  MODIFY `order_subscription_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_order_total`
--
ALTER TABLE `myopencart_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_product`
--
ALTER TABLE `myopencart_product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT for table `myopencart_product_code`
--
ALTER TABLE `myopencart_product_code`
  MODIFY `product_code_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_product_discount`
--
ALTER TABLE `myopencart_product_discount`
  MODIFY `product_discount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=441;

--
-- AUTO_INCREMENT for table `myopencart_product_image`
--
ALTER TABLE `myopencart_product_image`
  MODIFY `product_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2352;

--
-- AUTO_INCREMENT for table `myopencart_product_option`
--
ALTER TABLE `myopencart_product_option`
  MODIFY `product_option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=227;

--
-- AUTO_INCREMENT for table `myopencart_product_option_value`
--
ALTER TABLE `myopencart_product_option_value`
  MODIFY `product_option_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `myopencart_product_report`
--
ALTER TABLE `myopencart_product_report`
  MODIFY `product_report_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_product_reward`
--
ALTER TABLE `myopencart_product_reward`
  MODIFY `product_reward_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=546;

--
-- AUTO_INCREMENT for table `myopencart_return`
--
ALTER TABLE `myopencart_return`
  MODIFY `return_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_return_action`
--
ALTER TABLE `myopencart_return_action`
  MODIFY `return_action_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `myopencart_return_history`
--
ALTER TABLE `myopencart_return_history`
  MODIFY `return_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_return_reason`
--
ALTER TABLE `myopencart_return_reason`
  MODIFY `return_reason_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `myopencart_return_status`
--
ALTER TABLE `myopencart_return_status`
  MODIFY `return_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `myopencart_review`
--
ALTER TABLE `myopencart_review`
  MODIFY `review_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_seo_url`
--
ALTER TABLE `myopencart_seo_url`
  MODIFY `seo_url_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT for table `myopencart_setting`
--
ALTER TABLE `myopencart_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=219;

--
-- AUTO_INCREMENT for table `myopencart_startup`
--
ALTER TABLE `myopencart_startup`
  MODIFY `startup_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_statistics`
--
ALTER TABLE `myopencart_statistics`
  MODIFY `statistics_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `myopencart_stock_status`
--
ALTER TABLE `myopencart_stock_status`
  MODIFY `stock_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `myopencart_store`
--
ALTER TABLE `myopencart_store`
  MODIFY `store_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_subscription`
--
ALTER TABLE `myopencart_subscription`
  MODIFY `subscription_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_subscription_history`
--
ALTER TABLE `myopencart_subscription_history`
  MODIFY `subscription_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_subscription_log`
--
ALTER TABLE `myopencart_subscription_log`
  MODIFY `subscription_log_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_subscription_option`
--
ALTER TABLE `myopencart_subscription_option`
  MODIFY `subscription_option_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_subscription_plan`
--
ALTER TABLE `myopencart_subscription_plan`
  MODIFY `subscription_plan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `myopencart_subscription_product`
--
ALTER TABLE `myopencart_subscription_product`
  MODIFY `subscription_product_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_subscription_status`
--
ALTER TABLE `myopencart_subscription_status`
  MODIFY `subscription_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `myopencart_tax_class`
--
ALTER TABLE `myopencart_tax_class`
  MODIFY `tax_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `myopencart_tax_rate`
--
ALTER TABLE `myopencart_tax_rate`
  MODIFY `tax_rate_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;

--
-- AUTO_INCREMENT for table `myopencart_tax_rule`
--
ALTER TABLE `myopencart_tax_rule`
  MODIFY `tax_rule_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;

--
-- AUTO_INCREMENT for table `myopencart_theme`
--
ALTER TABLE `myopencart_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_topic`
--
ALTER TABLE `myopencart_topic`
  MODIFY `topic_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_translation`
--
ALTER TABLE `myopencart_translation`
  MODIFY `translation_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_upload`
--
ALTER TABLE `myopencart_upload`
  MODIFY `upload_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_user`
--
ALTER TABLE `myopencart_user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `myopencart_user_authorize`
--
ALTER TABLE `myopencart_user_authorize`
  MODIFY `user_authorize_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_user_group`
--
ALTER TABLE `myopencart_user_group`
  MODIFY `user_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `myopencart_user_login`
--
ALTER TABLE `myopencart_user_login`
  MODIFY `user_login_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `myopencart_user_token`
--
ALTER TABLE `myopencart_user_token`
  MODIFY `user_token_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `myopencart_weight_class`
--
ALTER TABLE `myopencart_weight_class`
  MODIFY `weight_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `myopencart_zone`
--
ALTER TABLE `myopencart_zone`
  MODIFY `zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4474;

--
-- AUTO_INCREMENT for table `myopencart_zone_to_geo_zone`
--
ALTER TABLE `myopencart_zone_to_geo_zone`
