...
$installs = $core->get_install_metadata($metadataDb,"wordpress");
?>
...
<div class="dashboard-wrapper">
  ...
  <a href="#" onclick="scan_wp(event)"
     class="btn btn-primary btn-lg px-5 py-2 rounded-pill shadow-sm d-flex align-items-center" id="scanWpBtn">
    
    <div id="spinnerContainer" style="display: none; justify-content: center; align-items: center;">
      <span id="themesSpinner" class="dashboard-spinner spinner-danger spinner-xs"></span>
    </div>

    <i class="fab fa-wordpress fa-lg me-2"></i>
    <span id="scanWpText" style="margin-left: 8px;">Scan WordPress Installations</span>
  </a>
</div>
...
$ran_db = str_replace($replacement_string, "", $ran_db);
    ...
    <a href="index.php?act=editdetail&amp;insid=26_93201" class="icon-btn mx-1" style="color: #FF5D00;" role="button"
...
var scan_url='<?= $globals['index'] . $core->buildCleanQueryString(['view' => 'scan_wordpress']); ?>';
